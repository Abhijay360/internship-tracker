...
export const SEED_APPLICATIONS: Application[] = [
  ...
  },
  {
    ...
    status: 'in_process',
    appliedDate: '2026-08-16',
    notes: 'Volunteer application — Johns Hopkins hackathon',
  ...
  },
  {
    id: 'music',
    company: 'MUSIC',
    role: 'Undergraduate Student Impact Council',
    logo: '/logos/music.svg',
    status: 'in_process',
    appliedDate: '2026-08-16',
    notes: 'Manning CICS council, 2026–2027. Meetings every other Monday 5:30–7pm. Deadline Sept 2.',
    location: 'Amherst, MA',
    kind: 'campus',
    season: '2026–2027',
    pay: pay(
      'Not paid',
      'Student impact council — unpaid. Recognition from the Dean for active participation. Meetings every other Monday 5:30–7pm plus subcommittees.',
      'MUSIC 2026–2027 application announcement',
    ),
  },
  {
    id: 'boeing',
