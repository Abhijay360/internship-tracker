...
export const SEED_APPLICATIONS: Application[] = [
  ...
  },
  {
    ...
    role: 'Technology Intern',
    logo: '/logos/marshallwace.svg',
    status: 'in_process',
    appliedDate: '2026-08-21',
    notes: 'Summer 2027 — New York (Jun 14 – Aug 22, 2027)',
    location: 'New York, NY',
    kind: 'internship',
    season: 'Summer 2027',
    pay: pay(
      '$72 / hr',
      'Compensation provided by you for this Technology Intern role.',
      'User-provided pay (Aug 2026)',
      { hourlyMin: 72, hourlyMax: 72 },
    ),
  },
  {
    id: 'boeing',
